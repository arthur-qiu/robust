...
predict_net.load_state_dict(torch.load('/mnt/lustrenew/yanglei/haonan/adversarial/logs/cifar10_warm/cifar10wrn_epoch_199.pt'))
...
def test_in_testset():
    ...
    with torch.no_grad():
        for data, target in test_loader:
            ...
            adv_data = adversary(predict_net, data, target)
