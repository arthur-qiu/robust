...
adversary = LinfPGDAttack(
        net, loss_fn=nn.CrossEntropyLoss(reduction="sum"), eps=8/255 * 2,
        nb_iter=20, eps_iter=2/255 * 2, rand_init=True, clip_min=-1.0,
...
def test_in_testset():
    ...
    for data, target in test_loader:
        ...
        with ctx_noparamgrad_and_eval(net):
            adv_data = adversary.perturb(2*data - 1, target)
