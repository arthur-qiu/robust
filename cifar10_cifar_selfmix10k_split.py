...
opt_alpha = opt_combine.PGD_combine(epsilon = 0.5, num_steps = 10, step_size = 0.1).cuda()
...
def mix_dataset():
    ...
    for class_name in classes:
        if not os.path.exists('/mnt/lustrenew/yanglei/haonan/data/cinic-10-cifar/selfcombine/'+class_name):
            os.makedirs('/mnt/lustrenew/yanglei/haonan/data/cinic-10-cifar/selfcombine/'+class_name)
    count = 0
    loss_avg = 0.0
    correct = 0
    for bx, by in train_loader:
        ...
        for j in range(new_bx.shape[0]):
            ...
            img.save('/mnt/lustrenew/yanglei/haonan/data/cinic-10-cifar/selfcombine/'+classes[by[0].data]+'/'+str(count)+'.png')
