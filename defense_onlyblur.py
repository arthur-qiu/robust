...
from models.zip import ZipNet, WideResNet, NoiseZipNet, BlurZipNet, Blur_WideResNet
import json
...
# Create model
net = Blur_WideResNet(args.layers, 10, args.widen_factor, dropRate=args.droprate)
