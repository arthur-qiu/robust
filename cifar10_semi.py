...
# Checkpoints
parser.add_argument('--save', '-s', type=str, default='./logs/cifar10_semi', help='Folder to save checkpoints.')
parser.add_argument('--load', '-l', type=str, default='./logs/cifar10_adv', help='Checkpoint path to resume / test.')
