...
train_loader = torch.utils.data.DataLoader(
    dset.ImageFolder(args.dataroot+'/cinic-10-cifar/train', transform=train_transform), batch_size=args.batch_size//4, shuffle=True,
...
sup_loader = torch.utils.data.DataLoader(
    dset.ImageFolder(args.dataroot+'/cinic-10-cifar/gan150k_s0', transform=train_transform), batch_size=args.batch_size//4*3, shuffle=True,
    num_workers=args.prefetch, pin_memory=torch.cuda.is_available())
